...
- Quick run/test setup: `doc/guides/quickstart.md`
- Planning internals and action mapping: `doc/architecture/03-planning.md`
- Execution internals and node details: `doc/architecture/04-execution.md`
- Deployment details (ROS2 modes): `doc/architecture/06-ros2.md`
- Full architecture map: `doc/architecture/01-overview.md`

...
| **Live plan** (in progress; Phases 0–2 + Phase 4 codec prerequisite complete; Phase 3 at real-Sleet schema validation) | [`la_cal_integration_plan.md`](la_cal_integration_plan.md) — LA-CAL (`owp`) transport plugin + OMS JSON codec, rung 1 of the OMS CAL join |

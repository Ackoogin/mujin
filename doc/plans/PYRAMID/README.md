...
| **Live plan** (proposed, not yet scheduled) | [`agra_p3_proto_to_sysml_xmi_plan.md`](agra_p3_proto_to_sysml_xmi_plan.md) — reverse MBSE: lift the A-GRA P3 `.proto` contract back into a Cameo-importable SysML XMI model, the inverse of the `sysml_parser.py` + `proto_generator.py` forward pipeline |

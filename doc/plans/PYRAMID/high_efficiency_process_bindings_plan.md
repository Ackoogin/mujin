...
| **Port abstraction** | **Done** | Native is first-class on the standard `pcl::Port` surface: `pcl::Port::publishNative(value, schema)` and `pcl::nativePayload<T>(msg)` in [`component.hpp`](../../../subprojects/PYRAMID/include/pcl/component.hpp), usable without the generated facade. |
...
| Interaction realization model | `subprojects/PYRAMID/doc/architecture/pyramid_interaction_semantics.md`, `subprojects/PYRAMID/doc/guides/port_abstraction_guide.md` |

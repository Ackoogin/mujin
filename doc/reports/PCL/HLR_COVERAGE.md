...
| HLR | Description | LLR(s) | Test File(s) |
|-----|-------------|--------|--------------|
| PCL.077 | Manifest Exclusive Realization Groups | 463, 464, 465, 466, 467, 468, 469, 474 | test_pcl_transport_routing |
...
| HLRs | 92 |
| LLRs | 389 |
| LLRs with at least one verifying test file | 389 |

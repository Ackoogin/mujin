...
- `doc/research/AME/neuro_symbolic_reasoning.md`
- `doc/concept.md`
- `doc/extensions.md`
- `doc/plans/AME/autonomy_assurance_plan.md`
- `README.md`
- `doc/reports/AME/stakeholder_summary.md`
...
`doc/research/AME/neuro_symbolic_reasoning.md` proposes an "Extension 8" for neuro-symbolic reasoning, but `doc/extensions.md` currently lists only seven extensions. The roadmap should either:
...
The sequence proposed in `doc/research/AME/neuro_symbolic_reasoning.md` is broadly correct. This review refines it as follows.

...
This document is a brief reference for the implemented architecture. See `doc/architecture/` for the full technical reference; see `TODO.md` for remaining work.

...
| Component | Path |
|-----------|------|
| AME data model proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/data_model/pyramid.data_model.autonomy.proto` |
| AME provided services proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/components/pyramid.components.autonomy_backend.services.provided.proto` |
| Common data model proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/data_model/pyramid.data_model.common.proto` |
| Tactical Objects data model proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/data_model/pyramid.data_model.tactical.proto` |
| Tactical Objects provided proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/components/pyramid.components.tactical_objects.services.provided.proto` |
| Tactical Objects consumed proto | `subprojects/PYRAMID/proofs/contracts/proto/pyramid/components/pyramid.components.tactical_objects.services.consumed.proto` |

...
| [`high_efficiency_process_bindings_plan.md`](../../plans/PYRAMID/high_efficiency_process_bindings_plan.md) | **Live plan (2026-07-19, proposed):** gap analysis + TODO for a zero-serialization native in-process payload path in the generated port bindings — PCL supports the pointer handoff (PCL.022), but the typed facades encode/decode even on local routes |

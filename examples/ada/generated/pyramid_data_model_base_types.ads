...
--  Generated from: base.proto by ada_service_generator.py --types
--  Package: Pyramid_Data_Model_Base_Types

with Ada.Strings.Unbounded;  use Ada.Strings.Unbounded;

package Pyramid_Data_Model_Base_Types is
...
end Pyramid_Data_Model_Base_Types;

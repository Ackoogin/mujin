...
package Pyramid.Data_model.Base.Flatbuffers_Codec is
   ...
   function From_Binary_Angle (Data : System.Address; Size : Interfaces.C.size_t)
   ...
   function From_Binary_Length (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Timestamp (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Identifier (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Speed (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Percentage (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,

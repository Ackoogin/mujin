...
The requirements are derived from the authoritative ROS2 architecture in `doc/architecture/06-ros2.md` and the node implementations under `ros2/include/ame_ros2/` and `ros2/src/nodes/`.

...
|------|-------------|----------------|
| TOBJ.005 | Interest requirement | Test_InterestManager |
...
| TOBJ.047 | Tactical object solution | Test_TacticalObjectsRuntime |
| TOBJ.048 | Derived evidence requirement | Test_InterestManager |
| TOBJ.049 | Requirement/evidence traceability | Test_TacticalObjectsRuntime |
...
| `Test_TacticalObjectsComponent_HLR.cpp` | Explicit HLR trace tags, coverage gaps |

...
The requirements are derived from the authoritative ROS2 architecture in `subprojects/AME/docs/architecture/06-ros2.md` and the node implementations under `subprojects/AME/ros2/include/ame_ros2/` and `subprojects/AME/ros2/src/nodes/`.

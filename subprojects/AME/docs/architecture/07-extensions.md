...
PDDL 2.1 durative actions with STN (Simple Temporal Network) conversion. See [`../research/temporal_extension_research.md`](../research/temporal_extension_research.md) for full planner evaluation.
...
See [`../research/neuro_symbolic_reasoning.md`](../research/neuro_symbolic_reasoning.md) and [`../reviews/neuro_symbolic_reasoning_review.md`](../reviews/neuro_symbolic_reasoning_review.md).

...
See `subprojects/AME/docs/architecture/` for the full architecture reference (7 numbered files covering system overview, WorldModel, planning, execution, observability, ROS2, and extensions).

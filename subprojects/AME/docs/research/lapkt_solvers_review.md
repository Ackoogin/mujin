...
- Matches AME's existing roadmap item: "Solver portfolio: try fast heuristic first, fall back to complete search" (`subprojects/AME/docs/TODO.md`).
...
4. **Safety assurance** — provably demonstrate that certain dangerous states are unreachable, supporting the SACE/AMLAS safety case (`subprojects/AME/docs/autonomy_assurance_plan.md`).

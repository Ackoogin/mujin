...
The symbolic pipeline remains the authority. Neural components are advisory. This is consistent with the safety case documented in `subprojects/AME/docs/autonomy_assurance_plan.md` and the SACE-PDDL evidence in `subprojects/AME/docs/sace-pddl/`.

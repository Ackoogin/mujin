...
| Panel | Content |
|-------|---------|
| **File Browser** | Browse `subprojects/AME/domains/` directory, open domain.pddl + problem.pddl |
...
Tasks:
1. File browser for `subprojects/AME/domains/` directory

...
`subprojects/PCL` contains the PYRAMID Composition Library runtime, public headers, examples, and PCL-owned tests.
...
- [Component system overview](doc/architecture/pcl-component-system.md)

...
package body Pyramid.Services.Tactical_Objects.Provided is
   ...
   function Try_Registry_Encode_Object_Match_Array
     (Content_Type : String;
      Payload      : Object_Match_Array;
      Wire         : out Unbounded_String) return Boolean
   is
      Effective : constant String :=
        (if Content_Type = "" then Json_Content_Type else Content_Type);
      Content_C : Interfaces.C.Strings.chars_ptr :=
        Interfaces.C.Strings.New_String (Effective);
      Schema_C : Interfaces.C.Strings.chars_ptr :=
        Interfaces.C.Strings.New_String ("ObjectMatchArray");
      Codec : Pcl_Plugins.Pcl_Codec_Const_Access := null;
      Msg   : aliased Pcl_Bindings.Pcl_Msg :=
        (Data      => System.Null_Address,
         Size      => 0,
            ...
            begin
               if Payload'Length = 0 then
                  ...
                  declare
                     ...
                     type Object_Match_Array_C_Array is array (Positive range 1 .. Count)
                       of aliased Pyramid_Object_Match_C;
                     pragma Convention (C, Object_Match_Array_C_Array);
                     Values : Object_Match_Array_C_Array := (others => (others => <>));
                  begin
                     ...
                     for I in Values'Range loop
                        Free_Object_Match (Values (I)'Access);
                     end loop;
                  end;
               end if;
            end;
   ...
   exception
      when others =>
         ...
         return False;
   end Try_Registry_Encode_Object_Match_Array;

   function Registry_Decode_Object_Match_Array
     (Msg : access constant Pcl_Bindings.Pcl_Msg)
   ...
   begin
      if Msg = null then
         raise Program_Error with "codec registry decode failed for schema ObjectMatchArray";
      end if;
      if Msg.Type_Name = Interfaces.C.Strings.Null_Ptr then
         Type_C := Interfaces.C.Strings.New_String (Json_Content_Type);
      end if;
      ...
      declare
         ...
         type Object_Match_Array_C_Array is array (Positive range 1 .. Count)
           of aliased Pyramid_Object_Match_C;
         pragma Convention (C, Object_Match_Array_C_Array);
         Values : Object_Match_Array_C_Array;
         for Values'Address use Slice.Ptr;
         pragma Import (Ada, Values);
         Result : Object_Match_Array (1 .. Count);
      begin
   ...
   exception
      when others =>
         ...
         raise;
   end Registry_Decode_Object_Match_Array;

   function Try_Registry_Encode_Object_Interest_Requirement_Array
     (Content_Type : String;
      Payload      : Object_Interest_Requirement_Array;
      Wire         : out Unbounded_String) return Boolean
   is
      Effective : constant String :=
        (if Content_Type = "" then Json_Content_Type else Content_Type);
      Content_C : Interfaces.C.Strings.chars_ptr :=
        Interfaces.C.Strings.New_String (Effective);
      Schema_C : Interfaces.C.Strings.chars_ptr :=
        Interfaces.C.Strings.New_String ("ObjectInterestRequirementArray");
      Codec : Pcl_Plugins.Pcl_Codec_Const_Access := null;
      Msg   : aliased Pcl_Bindings.Pcl_Msg :=
        (Data      => System.Null_Address,
         Size      => 0,
         ...
         if Codec.all.Encode /= null then
            ...
            begin
               if Payload'Length = 0 then
                  ...
                  declare
                     Count : constant Natural := Payload'Length;
                     type Object_Interest_Requirement_Array_C_Array is array (Positive range 1 .. Count)
                       of aliased Pyramid_Object_Interest_Requirement_C;
                     pragma Convention (C, Object_Interest_Requirement_Array_C_Array);
                     Values : Object_Interest_Requirement_Array_C_Array := (others => (others => <>));
                  begin
                     for Offset in 0 .. Count - 1 loop
                        To_C (Payload (Payload'First + Offset),
                              Values (Values'First + Offset));
                     ...
                     Status := Codec.all.Encode.all
                       (Codec.all.Codec_Ctx, Schema_C, Slice'Address, Msg'Access);
                     for I in Values'Range loop
                        Free_Object_Interest_Requirement (Values (I)'Access);
                     end loop;
                  end;
               end if;
            end;
   ...
   exception
      when others =>
         ...
         return False;
   end Try_Registry_Encode_Object_Interest_Requirement_Array;

   function Registry_Decode_Object_Interest_Requirement_Array
     (Msg : access constant Pcl_Bindings.Pcl_Msg)
   ...
   begin
      if Msg = null then
         raise Program_Error with "codec registry decode failed for schema ObjectInterestRequirementArray";
      end if;
      if Msg.Type_Name = Interfaces.C.Strings.Null_Ptr then
         Type_C := Interfaces.C.Strings.New_String (Json_Content_Type);
      end if;
      ...
      declare
         ...
         type Object_Interest_Requirement_Array_C_Array is array (Positive range 1 .. Count)
           of aliased Pyramid_Object_Interest_Requirement_C;
         pragma Convention (C, Object_Interest_Requirement_Array_C_Array);
         Values : Object_Interest_Requirement_Array_C_Array;
         for Values'Address use Slice.Ptr;
         pragma Import (Ada, Values);
         Result : Object_Interest_Requirement_Array (1 .. Count);
      begin
         for I in 1 .. Count loop
            From_C (Values (I), Result (I));
            Free_Object_Interest_Requirement (Values (I)'Access);
   ...
   exception
      when others =>
         ...
         raise;
   end Registry_Decode_Object_Interest_Requirement_Array;
   ...
   begin
      ...
      return Registry_Decode_Object_Match_Array (Msg);
   ...
   begin
      ...
      return Registry_Decode_Object_Interest_Requirement_Array (Msg);
   ...
   begin
      ...
      return Registry_Decode_Object_Detail_Array (Msg);
   ...
   is
      ...
      begin
         ...
         raise Program_Error with
           "codec registry encode failed for schema ObjectInterestRequirement";
      end Build_Payload;
      Payload : constant String := Build_Payload;
      Req_C  : Interfaces.C.Strings.chars_ptr := Interfaces.C.Strings.Null_Ptr;
      Payload_Bytes : aliased constant String := Payload;
      ...
      case Channel is
         when Ch_Matching_Objects_Read_Match =>
            ...
            begin
               ...
               begin
                  Require_Codec (Content_Type);  --  fail closed if no plugin
                  if not Try_Registry_Encode_Object_Match_Array
                    (Content_Type, Rsp, Wire_Response)
                  then
                     raise Program_Error with
                       "codec registry encode failed for schema ObjectMatchArray";
                  end if;
                  Copy_To_Buf
         ...
         when Ch_Object_Of_Interest_Create_Requirement =>
            declare
               ...
               begin
                  ...
                  raise Program_Error with
                    "codec registry decode failed for schema ObjectInterestRequirement";
               end Decode_Request;
         ...
         when Ch_Object_Of_Interest_Read_Requirement =>
            ...
            begin
               ...
               begin
                  Require_Codec (Content_Type);  --  fail closed if no plugin
                  if not Try_Registry_Encode_Object_Interest_Requirement_Array
                    (Content_Type, Rsp, Wire_Response)
                  then
                     raise Program_Error with
                       "codec registry encode failed for schema ObjectInterestRequirementArray";
                  end if;
                  Copy_To_Buf
                    (To_String (Wire_Response),
                    Response_Buf, Response_Size);

...
package body Pyramid.Services.Tactical_Objects.Provided is
      ...
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Grpc_Transport.Object_Match_Array :=
              Grpc_Transport.Invoke_Matching_Objects_Read_Match
      ...
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Identifier :=
              Grpc_Transport.Invoke_Object_Of_Interest_Create_Requirement
                (To_String (Grpc_Channel), Request);
      ...
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Grpc_Transport.Object_Interest_Requirement_Array :=
              Grpc_Transport.Invoke_Object_Of_Interest_Read_Requirement
                (To_String (Grpc_Channel), Request);
            Acc : Unbounded_String := To_Unbounded_String ("[");
         begin
            for I in Rsp'Range loop
   ...
   begin
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Ack :=
              Grpc_Transport.Invoke_Object_Of_Interest_Update_Requirement
                (To_String (Grpc_Channel), Request);
   ...
   begin
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Ack :=
              Grpc_Transport.Invoke_Object_Of_Interest_Delete_Requirement
                (To_String (Grpc_Channel), Request);
            Response_Payload : constant String := To_Json (Rsp);
         begin
            Emit_Invoke_Response
      ...
      if Content_Type = Grpc_Content_Type then
         ...
         declare
            Rsp : constant Grpc_Transport.Object_Detail_Array :=
              Grpc_Transport.Invoke_Specific_Object_Detail_Read_Detail
                (To_String (Grpc_Channel), Request);
            Acc : Unbounded_String := To_Unbounded_String ("[");
         begin
            for I in Rsp'Range loop

...
fbs::RequirementReferenceT to_fb(const pyramid::domain_model::RequirementReference& msg) {
...
pyramid::domain_model::RequirementReference from_fb(const fbs::RequirementReferenceT& msg, pyramid::domain_model::RequirementReference* /*tag*/) {
    pyramid::domain_model::RequirementReference out{};
    out.requirement_id = msg.requirement_id;
    out.component_name = msg.component_name;
    out.service_name = msg.service_name;
    out.type_name = msg.type_name;
...
fbs::AgentStateT to_fb(const pyramid::domain_model::AgentState& msg) {
    fbs::AgentStateT out{};
...
pyramid::domain_model::AgentState from_fb(const fbs::AgentStateT& msg, pyramid::domain_model::AgentState* /*tag*/) {
    pyramid::domain_model::AgentState out{};
    out.agent_id = msg.agent_id;
    out.agent_type = msg.agent_type;
    out.available = msg.available;
    return out;
...
fbs::PlanningPolicyT to_fb(const pyramid::domain_model::PlanningPolicy& msg) {
...
pyramid::domain_model::PlanningPolicy from_fb(const fbs::PlanningPolicyT& msg, pyramid::domain_model::PlanningPolicy* /*tag*/) {
    pyramid::domain_model::PlanningPolicy out{};
    out.max_replans = msg.max_replans;
    out.enable_replanning = msg.enable_replanning;
    return out;
}

fbs::PlanningGoalT to_fb(const pyramid::domain_model::PlanningGoal& msg) {
...
pyramid::domain_model::PlanningGoal from_fb(const fbs::PlanningGoalT& msg, pyramid::domain_model::PlanningGoal* /*tag*/) {
    pyramid::domain_model::PlanningGoal out{};
    ...
    out.name = msg.name;
    if (msg.requirement) {
        out.requirement = from_fb(*msg.requirement, static_cast<pyramid::domain_model::RequirementReference*>(nullptr));
    }
...
fbs::ExecutionPolicyT to_fb(const pyramid::domain_model::ExecutionPolicy& msg) {
...
pyramid::domain_model::ExecutionPolicy from_fb(const fbs::ExecutionPolicyT& msg, pyramid::domain_model::ExecutionPolicy* /*tag*/) {
    pyramid::domain_model::ExecutionPolicy out{};
    out.max_replans = msg.max_replans;
    out.enable_replanning = msg.enable_replanning;
    out.max_concurrent_placements = msg.max_concurrent_placements;
    return out;
...
fbs::WorldFactUpdateT to_fb(const pyramid::domain_model::WorldFactUpdate& msg) {
...
pyramid::domain_model::WorldFactUpdate from_fb(const fbs::WorldFactUpdateT& msg, pyramid::domain_model::WorldFactUpdate* /*tag*/) {
    pyramid::domain_model::WorldFactUpdate out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    out.value = msg.value;
    out.source = msg.source;
    out.authority = static_cast<pyramid::domain_model::FactAuthorityLevel>(msg.authority);
    return out;
}

fbs::StateUpdateT to_fb(const pyramid::domain_model::StateUpdate& msg) {
...
pyramid::domain_model::StateUpdate from_fb(const fbs::StateUpdateT& msg, pyramid::domain_model::StateUpdate* /*tag*/) {
    pyramid::domain_model::StateUpdate out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    for (const auto& item : msg.fact_update) {
        if (item) {
            out.fact_update.push_back(from_fb(*item, static_cast<pyramid::domain_model::WorldFactUpdate*>(nullptr)));
        }
    }
    return out;
}

fbs::CapabilitiesT to_fb(const pyramid::domain_model::Capabilities& msg) {
...
pyramid::domain_model::Capabilities from_fb(const fbs::CapabilitiesT& msg, pyramid::domain_model::Capabilities* /*tag*/) {
    pyramid::domain_model::Capabilities out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
...
fbs::PlannedComponentInteractionT to_fb(const pyramid::domain_model::PlannedComponentInteraction& msg) {
...
pyramid::domain_model::PlannedComponentInteraction from_fb(const fbs::PlannedComponentInteractionT& msg, pyramid::domain_model::PlannedComponentInteraction* /*tag*/) {
    pyramid::domain_model::PlannedComponentInteraction out{};
    out.target_component = msg.target_component;
    out.target_service = msg.target_service;
    out.target_type = msg.target_type;
    out.operation = static_cast<pyramid::domain_model::RequirementPlacementOperation>(msg.operation);
    return out;
}

fbs::PlanStepT to_fb(const pyramid::domain_model::PlanStep& msg) {
    fbs::PlanStepT out{};
    out.has_update_time = msg.update_time.has_value();
    if (msg.update_time.has_value()) {
        out.update_time = msg.update_time.value();
...
pyramid::domain_model::PlanStep from_fb(const fbs::PlanStepT& msg, pyramid::domain_model::PlanStep* /*tag*/) {
    pyramid::domain_model::PlanStep out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    for (const auto& item : msg.interaction) {
        if (item) {
            out.interaction.push_back(from_fb(*item, static_cast<pyramid::domain_model::PlannedComponentInteraction*>(nullptr)));
        }
    }
    return out;
}

fbs::PlanT to_fb(const pyramid::domain_model::Plan& msg) {
    fbs::PlanT out{};
    out.has_update_time = msg.update_time.has_value();
    if (msg.update_time.has_value()) {
        out.update_time = msg.update_time.value();
...
pyramid::domain_model::Plan from_fb(const fbs::PlanT& msg, pyramid::domain_model::Plan* /*tag*/) {
    pyramid::domain_model::Plan out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    for (const auto& item : msg.step) {
        if (item) {
            out.step.push_back(from_fb(*item, static_cast<pyramid::domain_model::PlanStep*>(nullptr)));
        }
    }
    out.compiled_bt_xml = msg.compiled_bt_xml;
...
fbs::RequirementPlacementT to_fb(const pyramid::domain_model::RequirementPlacement& msg) {
...
pyramid::domain_model::RequirementPlacement from_fb(const fbs::RequirementPlacementT& msg, pyramid::domain_model::RequirementPlacement* /*tag*/) {
    pyramid::domain_model::RequirementPlacement out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    out.target_requirement_id = msg.target_requirement_id;
    out.related_entity_id = msg.related_entity_id;
    out.progress = static_cast<pyramid::domain_model::Progress>(msg.progress);
    return out;
}
...
fbs::PlanningRequirementT to_fb(const pyramid::domain_model::PlanningRequirement& msg) {
...
pyramid::domain_model::PlanningRequirement from_fb(const fbs::PlanningRequirementT& msg, pyramid::domain_model::PlanningRequirement* /*tag*/) {
    pyramid::domain_model::PlanningRequirement out{};
    ...
    for (const auto& item : msg.upstream_requirement) {
        if (item) {
            out.upstream_requirement.push_back(from_fb(*item, static_cast<pyramid::domain_model::RequirementReference*>(nullptr)));
        }
    }
    out.goal.reserve(msg.goal.size());
    for (const auto& item : msg.goal) {
        if (item) {
            out.goal.push_back(from_fb(*item, static_cast<pyramid::domain_model::PlanningGoal*>(nullptr)));
        }
    }
    if (msg.policy) out.policy = from_fb(*msg.policy, static_cast<pyramid::domain_model::PlanningPolicy*>(nullptr));
    out.available_agents.reserve(msg.available_agents.size());
    for (const auto& item : msg.available_agents) {
        if (item) {
            out.available_agents.push_back(from_fb(*item, static_cast<pyramid::domain_model::AgentState*>(nullptr)));
        }
    }
    return out;
}

fbs::ExecutionRequirementT to_fb(const pyramid::domain_model::ExecutionRequirement& msg) {
...
pyramid::domain_model::ExecutionRequirement from_fb(const fbs::ExecutionRequirementT& msg, pyramid::domain_model::ExecutionRequirement* /*tag*/) {
    pyramid::domain_model::ExecutionRequirement out{};
    if (msg.base) out.base = from_fb(*msg.base, static_cast<pyramid::domain_model::Entity*>(nullptr));
    if (msg.status) out.status = from_fb(*msg.status, static_cast<pyramid::domain_model::Achievement*>(nullptr));
    out.upstream_requirement.reserve(msg.upstream_requirement.size());
    for (const auto& item : msg.upstream_requirement) {
    ...
    out.plan_id = msg.plan_id;
    if (msg.policy) out.policy = from_fb(*msg.policy, static_cast<pyramid::domain_model::ExecutionPolicy*>(nullptr));
    out.available_agents.reserve(msg.available_agents.size());
    for (const auto& item : msg.available_agents) {
        if (item) {
            out.available_agents.push_back(from_fb(*item, static_cast<pyramid::domain_model::AgentState*>(nullptr)));
...
fbs::ExecutionRunT to_fb(const pyramid::domain_model::ExecutionRun& msg) {
...
pyramid::domain_model::ExecutionRun from_fb(const fbs::ExecutionRunT& msg, pyramid::domain_model::ExecutionRun* /*tag*/) {
    pyramid::domain_model::ExecutionRun out{};
    if (msg.has_update_time) {
        out.update_time = msg.update_time;
    }
    out.id = msg.id;
    ...
    out.planning_requirement_id = msg.planning_requirement_id;
    out.plan_id = msg.plan_id;
    out.state = static_cast<pyramid::domain_model::ExecutionState>(msg.state);
    if (msg.achievement) out.achievement = from_fb(*msg.achievement, static_cast<pyramid::domain_model::Achievement*>(nullptr));
    out.replan_count = msg.replan_count;
    out.outstanding_placement.reserve(msg.outstanding_placement.size());
    for (const auto& item : msg.outstanding_placement) {
        if (item) {
            out.outstanding_placement.push_back(from_fb(*item, static_cast<pyramid::domain_model::RequirementPlacement*>(nullptr)));
        }
    }
    return out;
}
...
fbs::CapabilitiesArrayHolderT to_fb(const std::vector<pyramid::domain_model::Capabilities>& msg) {
...
std::vector<pyramid::domain_model::Capabilities> from_fb(const fbs::CapabilitiesArrayHolderT& msg) {
    std::vector<pyramid::domain_model::Capabilities> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::Capabilities*>(nullptr)));
        }
    }
    return out;
}

fbs::PlanningRequirementArrayHolderT to_fb(const std::vector<pyramid::domain_model::PlanningRequirement>& msg) {
...
std::vector<pyramid::domain_model::PlanningRequirement> from_fb(const fbs::PlanningRequirementArrayHolderT& msg) {
    std::vector<pyramid::domain_model::PlanningRequirement> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::PlanningRequirement*>(nullptr)));
        }
    }
    return out;
}

fbs::ExecutionRequirementArrayHolderT to_fb(const std::vector<pyramid::domain_model::ExecutionRequirement>& msg) {
...
std::vector<pyramid::domain_model::ExecutionRequirement> from_fb(const fbs::ExecutionRequirementArrayHolderT& msg) {
    std::vector<pyramid::domain_model::ExecutionRequirement> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::ExecutionRequirement*>(nullptr)));
        }
    }
    return out;
}

fbs::PlanArrayHolderT to_fb(const std::vector<pyramid::domain_model::Plan>& msg) {
...
std::vector<pyramid::domain_model::Plan> from_fb(const fbs::PlanArrayHolderT& msg) {
    std::vector<pyramid::domain_model::Plan> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::Plan*>(nullptr)));
        }
    }
    return out;
}

fbs::ExecutionRunArrayHolderT to_fb(const std::vector<pyramid::domain_model::ExecutionRun>& msg) {
...
std::vector<pyramid::domain_model::ExecutionRun> from_fb(const fbs::ExecutionRunArrayHolderT& msg) {
    std::vector<pyramid::domain_model::ExecutionRun> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::ExecutionRun*>(nullptr)));
        }
    }
    return out;
}

fbs::RequirementPlacementArrayHolderT to_fb(const std::vector<pyramid::domain_model::RequirementPlacement>& msg) {
...
std::vector<pyramid::domain_model::RequirementPlacement> from_fb(const fbs::RequirementPlacementArrayHolderT& msg) {
    std::vector<pyramid::domain_model::RequirementPlacement> out{};
    out.reserve(msg.items.size());
    for (const auto& item : msg.items) {
        if (item) {
            out.push_back(from_fb(*item, static_cast<pyramid::domain_model::RequirementPlacement*>(nullptr)));
        }
    }
    return out;
}
...
pyramid::domain_model::RequirementReference fromBinaryRequirementReference(const void* data, size_t size) {
    ...
    return from_fb(object, static_cast<pyramid::domain_model::RequirementReference*>(nullptr));
}
...
pyramid::domain_model::AgentState fromBinaryAgentState(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::AgentState*>(nullptr));
}
...
pyramid::domain_model::PlanningPolicy fromBinaryPlanningPolicy(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::PlanningPolicy*>(nullptr));
}
...
pyramid::domain_model::PlanningGoal fromBinaryPlanningGoal(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::PlanningGoal*>(nullptr));
}
...
pyramid::domain_model::ExecutionPolicy fromBinaryExecutionPolicy(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::ExecutionPolicy*>(nullptr));
}
...
pyramid::domain_model::WorldFactUpdate fromBinaryWorldFactUpdate(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::WorldFactUpdate*>(nullptr));
}
...
pyramid::domain_model::StateUpdate fromBinaryStateUpdate(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::StateUpdate*>(nullptr));
}
...
pyramid::domain_model::Capabilities fromBinaryCapabilities(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::Capabilities*>(nullptr));
}
...
pyramid::domain_model::PlannedComponentInteraction fromBinaryPlannedComponentInteraction(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::PlannedComponentInteraction*>(nullptr));
}
...
pyramid::domain_model::PlanStep fromBinaryPlanStep(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::PlanStep*>(nullptr));
}
...
pyramid::domain_model::Plan fromBinaryPlan(const void* data, size_t size) {
    ...
    fbs::PlanT object{};
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::Plan*>(nullptr));
}
...
pyramid::domain_model::RequirementPlacement fromBinaryRequirementPlacement(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::RequirementPlacement*>(nullptr));
}
...
pyramid::domain_model::PlanningRequirement fromBinaryPlanningRequirement(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::PlanningRequirement*>(nullptr));
}
...
pyramid::domain_model::ExecutionRequirement fromBinaryExecutionRequirement(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::ExecutionRequirement*>(nullptr));
}
...
pyramid::domain_model::ExecutionRun fromBinaryExecutionRun(const void* data, size_t size) {
    ...
    root->UnPackTo(&object);
    return from_fb(object, static_cast<pyramid::domain_model::ExecutionRun*>(nullptr));
}
...
void* pyramid_services_autonomy_backend_RequirementReference_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::RequirementReference*>(nullptr));
...
char* pyramid_services_autonomy_backend_RequirementReference_from_flatbuffer_json(const void* data, size_t size) {
    try {
        ...
        auto json = pyramid::domain_model::autonomy::toJson(value);
...
void* pyramid_services_autonomy_backend_AgentState_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::AgentState*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_PlanningPolicy_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::PlanningPolicy*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_PlanningGoal_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::PlanningGoal*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_ExecutionPolicy_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::ExecutionPolicy*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_WorldFactUpdate_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::WorldFactUpdate*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_StateUpdate_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::StateUpdate*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_Capabilities_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::Capabilities*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_PlannedComponentInteraction_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::PlannedComponentInteraction*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_PlanStep_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::PlanStep*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_Plan_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::Plan*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_RequirementPlacement_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::RequirementPlacement*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_PlanningRequirement_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::PlanningRequirement*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_ExecutionRequirement_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::ExecutionRequirement*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_ExecutionRun_to_flatbuffer_json(const char* json, size_t* size_out) {
    if (size_out) *size_out = 0;
    try {
        auto value = pyramid::domain_model::autonomy::fromJson(std::string(json ? json : ""), static_cast<pyramid::domain_model::ExecutionRun*>(nullptr));
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(value);
        if (size_out) *size_out = payload.size();
        if (payload.empty()) return nullptr;
        void* out = std::malloc(payload.size());
...
void* pyramid_services_autonomy_backend_CapabilitiesArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        ...
        std::vector<pyramid::domain_model::Capabilities> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::Capabilities*>(nullptr)));
            }
        }
...
void* pyramid_services_autonomy_backend_PlanningRequirementArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto arr = nlohmann::json::parse(std::string(json ? json : "[]"));
        std::vector<pyramid::domain_model::PlanningRequirement> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::PlanningRequirement*>(nullptr)));
            }
        }
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(values);
        if (size_out) *size_out = payload.size();
...
void* pyramid_services_autonomy_backend_ExecutionRequirementArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto arr = nlohmann::json::parse(std::string(json ? json : "[]"));
        std::vector<pyramid::domain_model::ExecutionRequirement> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::ExecutionRequirement*>(nullptr)));
            }
        }
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(values);
        if (size_out) *size_out = payload.size();
...
void* pyramid_services_autonomy_backend_PlanArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto arr = nlohmann::json::parse(std::string(json ? json : "[]"));
        std::vector<pyramid::domain_model::Plan> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::Plan*>(nullptr)));
            }
        }
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(values);
        if (size_out) *size_out = payload.size();
...
void* pyramid_services_autonomy_backend_ExecutionRunArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto arr = nlohmann::json::parse(std::string(json ? json : "[]"));
        std::vector<pyramid::domain_model::ExecutionRun> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::ExecutionRun*>(nullptr)));
            }
        }
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(values);
        if (size_out) *size_out = payload.size();
...
void* pyramid_services_autonomy_backend_RequirementPlacementArray_to_flatbuffer_json(const char* json, size_t* size_out) {
    ...
    try {
        auto arr = nlohmann::json::parse(std::string(json ? json : "[]"));
        std::vector<pyramid::domain_model::RequirementPlacement> values;
        if (arr.is_array()) {
            values.reserve(arr.size());
            for (const auto& item : arr) {
                values.push_back(pyramid::domain_model::autonomy::fromJson(item.dump(), static_cast<pyramid::domain_model::RequirementPlacement*>(nullptr)));
            }
        }
        auto payload = pyramid::services::autonomy_backend::flatbuffers_codec::toBinary(values);
        if (size_out) *size_out = payload.size();

    ...
    grpc::ServerWriter<::pyramid::data_model::tactical::ObjectDetail>* writer)
{
    try {
        ...
        const auto executor_response = invoke_executor(
            executor_, "object_evidence.read_detail", payload);
    ...
    ::pyramid::data_model::base::Identifier* response)
{
    try {
        ...
        const auto payload = serialize_grpc_request(*request);
        const auto executor_response = invoke_executor(
            executor_, "object_solution_evidence.create_requirement", payload);
    ...
    grpc::ServerWriter<::pyramid::data_model::tactical::ObjectEvidenceRequirement>* writer)
{
    try {
        ...
        const auto payload = serialize_grpc_request(*request);
        const auto executor_response = invoke_executor(
            executor_, "object_solution_evidence.read_requirement", payload);
        return write_stream_response<::pyramid::data_model::tactical::ObjectEvidenceRequirement>(
    ...
    ::pyramid::data_model::common::Ack* response)
{
    try {
        ...
        const auto payload = serialize_grpc_request(*request);
        const auto executor_response = invoke_executor(
            executor_, "object_solution_evidence.update_requirement", payload);
        return parse_unary_response(
    ...
    ::pyramid::data_model::common::Ack* response)
{
    try {
        ...
        const auto payload = serialize_grpc_request(*request);
        const auto executor_response = invoke_executor(
            executor_, "object_solution_evidence.delete_requirement", payload);
        return parse_unary_response(
    ...
    grpc::ServerWriter<::pyramid::data_model::common::Capability>* writer)
{
    try {
        ...
        const auto payload = serialize_grpc_request(*request);
        const auto executor_response = invoke_executor(
            executor_, "object_source_capability.read_capability", payload);
        return write_stream_response<::pyramid::data_model::common::Capability>(
            executor_response, writer, "ReadCapability");
    } catch (const std::exception& ex) {
        return grpc::Status(grpc::StatusCode::INTERNAL, ex.what());
    }
}
...
struct GrpcServer::Impl {
    std::unique_ptr<grpc_transport::Object_Evidence_ServiceImpl> object_evidence_service;
    std::unique_ptr<grpc_transport::Object_Solution_Evidence_ServiceImpl> object_solution_evidence_service;
    std::unique_ptr<grpc_transport::Object_Source_Capability_ServiceImpl> object_source_capability_service;
                           ...
                           pcl_executor_t* executor)
{
    ...
    impl->object_evidence_service = std::make_unique<grpc_transport::Object_Evidence_ServiceImpl>(executor);
    builder.RegisterService(impl->object_evidence_service.get());

    impl->object_solution_evidence_service = std::make_unique<grpc_transport::Object_Solution_Evidence_ServiceImpl>(executor);
    builder.RegisterService(impl->object_solution_evidence_service.get());

    impl->object_source_capability_service = std::make_unique<grpc_transport::Object_Source_Capability_ServiceImpl>(executor);
    builder.RegisterService(impl->object_source_capability_service.get());

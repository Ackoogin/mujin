...
For high-level requirements see [`HLR.md`](../../requirements/tactical_objects/HLR.md). For the concrete class design see [`DESIGN.md`](DESIGN.md). For low-level requirements and traceability see [`LLR.md`](../../requirements/tactical_objects/LLR.md) and [`HLR_COVERAGE.md`](../../../../../doc/reports/PYRAMID/tactical_objects/HLR_COVERAGE.md).

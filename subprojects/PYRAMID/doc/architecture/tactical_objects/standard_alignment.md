...
interop tests (see [generated_bindings.md](../generated_bindings.md) and the
CTest suite).
...
Broader generated-binding, gRPC, ROS2, and transport coverage lives in the
CTest suite; outstanding work is tracked in

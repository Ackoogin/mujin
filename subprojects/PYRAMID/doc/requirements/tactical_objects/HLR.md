...
Identifiers use global responsibility IDs from `subprojects/PYRAMID/doc/architecture/PYRAMID_COMPONENT_RESPONSIBILITIES.md` (`COMP-060`, `PYR-RESP-0729` to `PYR-RESP-0745`).

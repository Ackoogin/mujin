...
Low-level requirements for `pyramid/tactical_objects`, derived from the high-level requirements in [`HLR.md`](HLR.md) and the design decisions in [`DESIGN.md`](../../architecture/tactical_objects/DESIGN.md).

Each LLR maps to at least one unit or component test. Tests use requirement tags in the form `///< REQ_TACTICAL_OBJECTS_NNN: ...`.

See [`HLR_COVERAGE.md`](../../../../../doc/reports/PYRAMID/tactical_objects/HLR_COVERAGE.md) and the test list in [`README.md`](../../../tactical_objects/README.md) for current verification coverage.

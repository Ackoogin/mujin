...
/// \brief Consumes requests and exchanges sensor-planning MA-Action data.
class SensorPlannerComponent final : public pcl::Component {
 public:
  /// \brief Compose the sensor planner's generated P3 types and PCL ports.
  explicit SensorPlannerComponent(pcl::Executor& executor);

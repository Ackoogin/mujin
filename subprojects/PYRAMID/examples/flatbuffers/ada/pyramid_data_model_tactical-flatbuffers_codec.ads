...
package Pyramid.Data_model.Tactical.Flatbuffers_Codec is
   ...
   function From_Binary_Object_Detail (Data : System.Address; Size : Interfaces.C.size_t)
   ...
   function From_Binary_Object_Evidence_Requirement (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Object_Interest_Requirement (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,
   ...
   function From_Binary_Object_Match (Data : System.Address; Size : Interfaces.C.size_t)
     return System.Address
     with Import, Convention => C,

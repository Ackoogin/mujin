...
pyramid::domain_model::GeodeticPosition fromBinaryGeodeticPosition(
    const void* data, size_t size);
inline pyramid::domain_model::GeodeticPosition fromBinaryGeodeticPosition(
    const std::string& s) {
...
pyramid::domain_model::Achievement fromBinaryAchievement(
    const void* data, size_t size);
inline pyramid::domain_model::Achievement fromBinaryAchievement(
    const std::string& s) {
...
pyramid::domain_model::CircleArea fromBinaryCircleArea(
    const void* data, size_t size);
inline pyramid::domain_model::CircleArea fromBinaryCircleArea(
    const std::string& s) {
...
pyramid::domain_model::ObjectDetail fromBinaryObjectDetail(
    const void* data, size_t size);
inline pyramid::domain_model::ObjectDetail fromBinaryObjectDetail(
    const std::string& s) {
...
pyramid::domain_model::ObjectEvidenceRequirement fromBinaryObjectEvidenceRequirement(
    const void* data, size_t size);
inline pyramid::domain_model::ObjectEvidenceRequirement fromBinaryObjectEvidenceRequirement(
    const std::string& s) {
...
pyramid::domain_model::ObjectInterestRequirement fromBinaryObjectInterestRequirement(
    const void* data, size_t size);
inline pyramid::domain_model::ObjectInterestRequirement fromBinaryObjectInterestRequirement(
    const std::string& s) {
  return fromBinaryObjectInterestRequirement(s.data(), s.size());
}

std::string toBinary(const pyramid::domain_model::ObjectMatch& msg);
pyramid::domain_model::ObjectMatch fromBinaryObjectMatch(
    const void* data, size_t size);
inline pyramid::domain_model::ObjectMatch fromBinaryObjectMatch(
    const std::string& s) {
  return fromBinaryObjectMatch(s.data(), s.size());
}

std::string toBinary(const pyramid::domain_model::Capability& msg);
pyramid::domain_model::Capability fromBinaryCapability(
    const void* data, size_t size);
inline pyramid::domain_model::Capability fromBinaryCapability(
    const std::string& s) {
  return fromBinaryCapability(s.data(), s.size());
}

std::string toBinary(const pyramid::domain_model::Identifier& msg);
pyramid::domain_model::Identifier fromBinaryIdentifier(
    const void* data, size_t size);
inline pyramid::domain_model::Identifier fromBinaryIdentifier(
    const std::string& s) {
...
std::vector<pyramid::domain_model::ObjectDetail> fromBinaryObjectDetailArray(
    const void* data, size_t size);
inline std::vector<pyramid::domain_model::ObjectDetail> fromBinaryObjectDetailArray(
    const std::string& s) {
...
inline std::vector<pyramid::domain_model::ObjectEvidenceRequirement>
fromBinaryObjectEvidenceRequirementArray(const std::string& s) {
...
std::vector<pyramid::domain_model::Capability> fromBinaryCapabilityArray(
    const void* data, size_t size);
inline std::vector<pyramid::domain_model::Capability> fromBinaryCapabilityArray(
    const std::string& s) {
...
std::vector<pyramid::domain_model::ObjectMatch> fromBinaryObjectMatchArray(
    const void* data, size_t size);
inline std::vector<pyramid::domain_model::ObjectMatch> fromBinaryObjectMatchArray(
    const std::string& s) {
...
inline std::vector<pyramid::domain_model::ObjectInterestRequirement>
fromBinaryObjectInterestRequirementArray(const std::string& s) {
